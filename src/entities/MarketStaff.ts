 ...
 * put it out, one shelf at a time.
 */
export class MarketStaff extends Agent {
  ...
  constructor(public role: 'cashier' | 'stocker', public checkout: Checkout | null, private home: THREE.Vector3, private m: Market, from?: THREE.Vector3) {
    super(role === 'cashier'
  ...
  private get mates() {
    return this.m.staff.filter((s) => s !== this && s.role === 'stocker' && !s.leaving);
  }
